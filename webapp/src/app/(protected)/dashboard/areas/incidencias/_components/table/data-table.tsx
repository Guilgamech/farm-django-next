...
import { TIncidencia } from "@/schema/incidencia.schema"; // Asegúrate de tener el esquema correcto para Incidencia
import { useIncidenciaStore } from "@/context/incidencia"; // Importa el contexto y el hook adecuadamente

const columns: ColumnDef<TIncidencia>[] = [
  {
    accessorKey: "type",
    header: ({ column }) => {
      return (
...
const globalFilterFn: FilterFn<TIncidencia> = (row, columnId, filterValue, addMeta) => {
